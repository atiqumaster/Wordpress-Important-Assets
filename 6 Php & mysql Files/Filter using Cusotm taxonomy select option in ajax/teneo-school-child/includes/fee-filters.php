      ...
      <form action="" method="" id="school_search_form">
        ...
        <div class="row section-one mt-5 p-3">
            <div class="col-lg-12 col-md-12 col-sm-12 first-row-texts mt-2" >
                <h4 class=" text-dark">Discover our fees below</h4>
                <h6 class="pt-2 text-white">Choose your grade and language of instruction to find out your fee options. </h6>
            </div>
        </div>
             <hr class="filter_line_break" ></hr>
        <div class="row row-one">
            <div class="col-xl-12 col-lg-12 col-md-12 p-1 ps-4 pe-4" >
                <h5 class="mb-4" >Designed with your family's lifestyle in mind</h5>
                <p>We offer parents a choice between Real-Time Flex and Real-Time Plus structures for Grades 4 - 12, with the additional option to choose one of three examination boards - SACAI, IEB or Pearson Edexcel - from Grades 10 to Grade 12.</p>
                <p class="hidden_costs fst-italic mt-3">No hidden costs, no fuss</P>
            </div>
        </div>
        <hr class="filter_line_break" ></hr>
        <div class="row row-two">
            <div id="schools-ajax-loading" style="display: none;"><i class="fa fa-spin fa-spinner"></i> Loading</div>
            <div class="col-lg-3 col-md-5 col-sm-12 py-sm-3 py-3 ps-4 pe-4">
                <p class="pb-sm-0" >Choose your grade:</p>
            ...
            <div class="col-lg-5 col-md-7 col-sm-12 py-sm-3 py-3 ps-4 pe-4">
                <p>Choose your language of instruction:</p>
                <div class="select-Second-rows" >
            ...
            <div class="col-lg-4 col-md-12 col-sm-12 mt-4">
                <div class="row">
                    <div class="col d-flex justify-content-end">
                        <div class=" text-center filter-button filter_btn_one" style="border: 1px solid #D0E6F4;
            ...
            <div class="col-lg-12 mt-3">
                    ...
                    ">
                      ...
                      <div class=" text-center">
                       <?php $examination_board_image = get_field('examination_board_image', 'examination_board' . '_' . $examination_board->term_id); ?>
                        <img class="" src="<?php echo $examination_board_image;?>" alt="" style="">  
				...
				<?php	}?> 
                  ...
                  <div class=" after-select-option-text-mob mt-4">
                    ...
                    <button type="button" class="btn rounded-pill button-one-last mt-3" id="find_my_school_btn" style="background: #16243E;box-shadow: 0px 1px 8px rgba(0, 0, 0, 0.25);color: #ffffff; width:100% !important; margin-bottom:20px;"> Find my school!
                    </button>
                  ...
                  <div class="col-sm-12 mt-4 d-block d-md-none">
                        <div class="row">
                            <div class="col d-flex justify-content-end">
                                <div class=" text-center filter-button filter_btn_two" style="border: 1px solid #D0E6F4;
                  ...
                  <input type="hidden" name="filters_type" id="filters_type" value="fees"  />
                  <input type="hidden" name="filters_page_url" id="filters_page_url" value="<?php echo get_permalink( 1205 ); ?>"  />
...
if(count ($filters_arr) > 1) {
	...
	$schools_html = get_fees_data_school_listing_html($filters_arr);
	echo $schools_html;
}
